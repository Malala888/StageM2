...
// ─── Cache mémoire ───
let sectionMouvementsCache = null;
let sectionMouvementsCacheTime = 0;
const CACHE_TTL_MS = 15000;

async function fetchSectionMouvementsData() {
  const now = Date.now();
  if (sectionMouvementsCache && now - sectionMouvementsCacheTime < CACHE_TTL_MS) {
    return sectionMouvementsCache;
  }
  ...
  // Filtrer les mouvements par section du chef (via les brigades de sa section)
  ...
  sectionMouvementsCacheTime = now;
  return result;
}

// ─── Loader ───
export async function sectionMouvementsLoader() {
  return fetchSectionMouvementsData();
}

// ─── ErrorElement ───
export function SectionMouvementsError() {
...
export default SectionMouvements;