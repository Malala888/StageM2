...
const SectionRapports = () => {
  ...
  // Le stock est déjà scopé à la section par le backend ; on ne filtre en plus
  // que par brigade si demandé (le champ brigade sur Stock, quand renseigné).
  ...
  const handleGenerer = (e) => {
    e.preventDefault();
    // Les cartes ci-dessous se recalculent déjà en direct à chaque changement de filtre.
  ...
  const handleExportPDF = () => {
    ...
    const html = `
      <html>
        <head>
          <title>Rapport Section - ${dateStr}</title>
          <style>
          ...
          <main className="main">
            ...
            <div className="page-header">
              <div>
                <h1>Rapports</h1>
                <div className="sub">
                  Analyses et statistiques — Section <span className="section-badge">{sectionName}</span>
                </div>
              </div>
            ...
            <div className="report-grid">
              ...
              <div className="report-card" onClick={() => handleCardClick('Mouvements', `${totalMouvementsF} opérations`)}>
                <div className="icon">🔄</div>
