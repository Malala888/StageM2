    ...
    <>
      ...
      <aside className="sidebar">
        ...
        <nav className="sidebar-menu">
          <NavLink to="/section/dashboard" className={({ isActive }) => isActive ? 'active' : ''}>
          ...
          <NavLink to="/section/materiels" className={({ isActive }) => isActive ? 'active' : ''}>
            <svg viewBox="0 0 24 24"><rect x="2" y="7" width="20" height="14" rx="2" /><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16" /></svg>
            Matériels
          </NavLink>
          <NavLink to="/section/mouvements" className={({ isActive }) => isActive ? 'active' : ''}>
            <svg viewBox="0 0 24 24"><path d="M4 4h16v16H4z" /><path d="M8 8h8" /><path d="M8 12h6" /><path d="M8 16h4" /></svg>
            Mouvements
          </NavLink>
          <NavLink to="/section/stock" className={({ isActive }) => isActive ? 'active' : ''}>
            <svg viewBox="0 0 24 24"><path d="M20 7l-8-4-8 4m16 0v10l-8 4m8-4l-8 4m-8-4l8-4m-8-4v10l8 4" /></svg>
            Stock
          </NavLink>
          <NavLink to="/section/users" className={({ isActive }) => isActive ? 'active' : ''}>
            <svg viewBox="0 0 24 24"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" /><circle cx="9" cy="7" r="4" /><path d="M23 21v-2a4 4 0 0 0-3-3.87" /><path d="M16 3.13a4 4 0 0 1 0 7.75" /></svg>
            Utilisateurs
          </NavLink>
          <NavLink to="/section/rapports" className={({ isActive }) => isActive ? 'active' : ''}>
            <svg viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg>
            Rapports
          </NavLink>
          <NavLink to="/section/parametres" className={({ isActive }) => isActive ? 'active' : ''}>
